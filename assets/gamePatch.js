...
if (event.target.style.backgroundImage.includes('clear') && event.target.parentElement.classList.contains('ask-first') && !confirm("Are you sure you'd like to clear?")) return; It(st[e].element), st[e].action()
  }
